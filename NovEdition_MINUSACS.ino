...
void MLowPower() {
  ...
  if ((millis() - LowPowerTimer) >= 14400000 ||  MSH.Battery > 50) { //random integer, needs mission rehearsal
...
//Functions below are used by command!
